...
const Actions: React.FC<CampaignActionProps> = ({
  ...
  return (
    <Box className="mt-10 flex flex-row justify-start items-center">
      <CustomButton
        className={`w-40 h-12 mr-5 rounded-md text-md border-2 bg-transparent ${
      ...
      {activeStep < finalStep && (
        <CustomButton
          className="w-40 h-12 mr-5 rounded-md text-white text-md border-2 border-blue-800 bg-blue-800"
          onClick={handleNext}
        >
          Next
        </CustomButton>
